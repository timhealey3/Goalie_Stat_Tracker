...
import { StyleSheet, Text, View, SafeAreaView, Button, TextInput, Image, Pressable, TouchableOpacity, FlatList, Modal } from 'react-native';
...
function AddScreen({ navigation }) {
  ...
  const handleSettingsPress = () => {
    // Add functionality to open your settings screen or perform settings-related actions
    console.log("test");
  };
  ...
  return (
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center'}}>
      <SettingBtn onPress={handleSettingsPress} />
